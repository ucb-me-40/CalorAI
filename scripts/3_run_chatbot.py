...
LORA_ADAPTER_DIR = Path("./phi3_calorai_adapter")
...
def load_fine_tuned_model():
    ...
    print(f"✅ Phi-3 CalorAI loaded successfully from {LORA_ADAPTER_DIR}")
...
def run_chat_loop(model, tokenizer, retriever):
    ...
    while True:
        ...
        if user_input.lower() in ['quit', 'exit']:
            print("CalorAI: Go Bears! Study hard!")
            break
        ...
        try:
            ...
            print(f"CalorAI: {response_text.strip()}")
